...
public class MainMenu : MonoBehaviour
{
	...
	public void Awake()
	{
		...
		{
			TransitionToState(MenuState.Lobby);
		}
	}
	...
	public void Update()
	{
		...
		if (state == MenuState.LogIn || Application.isEditor)
		{
	...
	{
		MenuState prevState = this.state;
	...
	{
		TransitionToState(MenuState.Customize);
	}

	public void OnCustomizeGoBackClick()
	{
		TransitionToState(MenuState.Main);
	}
	...
	public void OnFindGameClick()
	{
		...
		//
		//TransitionToState(MenuState.GameList);
