...
public class InterpolatedTransform : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
		...
		//print("Resetting to most recent at " + transform.localPosition + "   " + Time.time);
    }
    ...
    public IEnumerator LateFixedUpdate()
    {
		...
		//print("Setting newest transform at " + transform.localPosition + "   " + Time.time);
	}
	...
	void Update()
    {
		...
		//print("interpolating from " + olderTransform.position + " to " + newestTransform.position + "   " + Time.time);
	}
